...
class SO(models.Model):
    ...
    def onchange_partner_style(self):
        self.style = self.company_id.partner_id.style or self.env.user.company_id.df_style or self.env.ref(
    ...
    style = fields.Many2one(
        ...
        default=lambda self: self.company_id.partner_id.style or self.env.user.company_id.
        df_style)
